"""
This library provides a number of functions to manipulate a graph.
"""
...
def getNeighbors(G,n):
    """
    Input: G, a graph and n, a node in G
    Output: Return a list of nodes in G to which n is connected.
    """
    return G[n]
...
def delLink(G, n1, n2):
    ...
    Output:
      - If n1 and n2 are in G, G will be updated with the undirected link
        (n1,n2) removed from G and return True.
    ...
    if n1 not in G or n2 not in G:
        ...
        print("Error: The link is not in the graph.")
        return False
